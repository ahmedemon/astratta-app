            ...
            <div class="card">
                ...
                <div class="card-body px-3">
                    <div class="row">
                        ...
                        @include('maintenance.action', ['action' => 'migrate_fresh', 'name' => 'Migrate Fresh'])
                        ...
                        @include('maintenance.action', ['action' => 'storage_link', 'name' => 'Storage Link'])
                        {{-- @include('maintenance.action', ['action' => 'seed', 'name' => 'Seed']) --}}
                    </div>
                </div>
            </div>
        </div>
