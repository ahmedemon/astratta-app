                    ...
                    <div>
                        ...
                        <form action="{{ route('painting.search') }}" method="POST" class="d-flex justify-content-center">
                            ...
                            <div class="input-group">
                                <input type="text" name="search_key" class="form-control shadow-none border border-right-0" placeholder="Search Here..." value="{{ Request::is('paintings/short/by*') || Request::is('paintings/newest') || Request::is('paintings/oldest') ? '' : $key }}" autocomplete="search_key" />
        ...
        <div class="container section2-container-2 px-lg-0">
            <div class="row best-selling-container justify-content-lg-between justify-content-md-between justify-content-center w-100">
                @if ($paintings->count() < 1)
                    <h3 class="text-center mt-5 mb96">No paint found!</h3>
                @else
