                    ...
                    <form action="{{ route('admin.blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" id="topic" name="topic" value="{{ old('topic', $blog->topic) }}" class="form-control @error('topic') is-invalid @enderror" placeholder="Topic...">
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" id="title" name="title" value="{{ old('title', $blog->title) }}" class="form-control @error('title') is-invalid @enderror" placeholder="Title...">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="description">Description</label>
                                <textarea type="text" id="description" name="description" class="form-control @error('description') is-invalid @enderror" placeholder="Description..." style="height: 250px;">{{ old('description', $blog->description) }}</textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="d-grid mb30 d-grid justify-content-center">
                                    <div class="avatar-upload text-center">
                                        ...
                                        <div class="avatar-preview">
                                            <div id="imagePreview" style="background-image: url('{{ asset('storage/blogs/' . $blog->image) }}')"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
