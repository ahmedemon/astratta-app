    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button class="close btn btn-sm shadow-none rounded-0 border-0" type="button" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-footer">
                ...
                <a href="{{ route('admin.logout') }}" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#logoutModal" onclick="event.preventDefault(); document.getElementById('vendor-logout-form').submit();">Sign Out</a>
